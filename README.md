...
Conforme dito, foram criados três (3) arquivos do tipo "HTML", juntamente de três (3) arquivos do tipo "CSS". Esses arquivos fazem referência a seu respectivo correspondente, por exemplo, a página HTML "index.html" faz referência ao arquivo do tipo CSS (index.css), assim sucessitivamente. <br>
...
Conforme dito, foi criado um (1) arquivo do tipo JS 
